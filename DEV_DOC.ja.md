# 環境構築 - Set up the environment from scratch (prerequisites, configuration files, secrets).
## 前提条件
...
# ビルドと実行 -  Build and launch the project using the Makefile and Docker Compose.
...
# 運用コマンド - Use relevant commands to manage the containers and volumes.
...
# データ管理 - Identify where the project data is stored and how it persists.
